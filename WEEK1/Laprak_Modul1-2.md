...
1. Download Wireshark terlebih dahulu dengan menggunakan link berikut ini : [Download Wireshark](http://www.wireshark.org/)
   ![Tampilann pada web download Wireshark](../assets/image/Modul1.1.png)
...
2. Setelah downnload selesai lakukan installasi Wireshark di laptop, dengan cara klik dua kali file yang telah kalian download
   ![Tampilan setelah di klik dua kali](../assets/image/Modul1.2.png)
   Pilih open
   ![Tampian setelah pilih open](../assets/image/Modul1.3.png)
   Geser Wireshark ke application dan juga lakukan intsall ChmodBPF.pkg
3. Tampilan setelah klik install ChmodBPF.pkg
   ![Tampilannya akan seperti ini](../assets/image/Modul1.4.png)
   Pilih continue
   ![Tampilann setelah contine](../assets/image/Modul1.5.png)
   Pilih continue lagi
   ![Tampilann setelah continue kedua](../assets/image/Modul1.6.png)
   Pilih install
   ![Tampilann akhir install ChmodBPF.pkg](../assets/image/Modul1.7.png)
